...
func Spotify() [][]string {
	...
	collectorSpotify.Visit("https://kworb.net/spotify/country/fr_daily.html")
...
func AppleMusic() [][]string {
	...
	collectorAppleMusic.Visit("https://kworb.net/charts/apple_s/fr.html")
...
func Deezer() [][]string {
	...
	collectorDeezer.Visit("https://kworb.net/charts/deezer/fr.html")
